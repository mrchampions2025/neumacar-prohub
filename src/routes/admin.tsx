...
import { Loader2, LayoutDashboard, Car, Users, LogOut, CalendarClock, ExternalLink, ShieldCheck, FileSpreadsheet, Menu, X, Settings2, BookOpen } from "lucide-react";
...
function AdminLayout() {
  ...
  const navItems = [
    ...
    { to: "/admin/historial", label: "Gestor Historial", icon: BookOpen },
